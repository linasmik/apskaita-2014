...
;(function ($, window, document, undefined) {
    ...
    $.fn.mapbox = function (options, callback) {
        ...
        function _zoom(distance) {
			...
			if(move == limit)
			{
				$(".map-control a.zoom").css({opacity: "0.4",filter: "alpha(opacity=40)",cursor: "default"});
			}
			else if(move > 0)
			{
				$(".map-control a.zoom").css({opacity: "1",filter: "alpha(opacity=100)",cursor: "pointer"});
				$(".map-control a.back").css({opacity: "1",filter: "alpha(opacity=100)",cursor: "pointer"});
			}
			else
			{
				$(".map-control a.back").css({opacity: "0.4",filter: "alpha(opacity=40)",cursor: "default"});
			}
